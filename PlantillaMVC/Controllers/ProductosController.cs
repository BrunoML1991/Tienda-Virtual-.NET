...
namespace PlantillaMVC.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Descrip,Cantidad,Precio,FotoID")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Descrip,Cantidad,Precio,FotoID")] Producto producto)
        {
            if (ModelState.IsValid)
            {
